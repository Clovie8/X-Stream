...
if(isset($_POST['live_search'])) {
    ...
    // Search in Name or Comment text
    $query = "SELECT * FROM `comments` WHERE name LIKE '%{$search_term}%' OR comment LIKE '%{$search_term}%' ORDER BY id DESC LIMIT 10";
    ...
    if(mysqli_num_rows($execut) > 0){
        ...
        echo "<tr><td colspan='5' style='text-align:center;'>No comments found</td></tr>";
    }
    exit(); 
}
...
if (isset($_SESSION['email']) && isset($_SESSION['key'])) {
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])){
        ...
        $whereClause = "WHERE name LIKE '%$search_val%' OR comment LIKE '%$search_val%'";
    ...
    $sql_count = "SELECT COUNT(id) FROM comments $whereClause";
...
<body>
    <div class="admin-container">
        ...
        <div class="admin-main">
            ...
            <div class="admin-content">
                <div class="content-header">
                    <h1 class="page-title">What People Are Saying</h1>
                    <div>
                        <button class="btn btn-secondary" onclick="window.location.href='comment'">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            $select = "SELECT * FROM `comments` $whereClause ORDER BY id DESC LIMIT $start_from, $limit";
                            ...
                            <table class="table">
                                ...
                                <tbody id="commentTableBody">
                                    ...
                                    if(mysqli_num_rows($execut) > 0) {
                                        ...
                                        echo "<tr><td colspan='5' style='text-align:center; padding:20px;'>No comments found.</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
        ...
        <div class="container-delete" id="contdelete">
            <div class="main-delete" id="maindelete">
                <p>Are you sure you want to delete comment of <b id="deleteItemName">this item</b>?</p>
    ...
    <script>
        ...
        document.getElementById('liveSearchInput').addEventListener('keyup', function() {
            ...
            .then(data => {
                document.getElementById('commentTableBody').innerHTML = data;
