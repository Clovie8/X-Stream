...
if(isset($_POST['live_search'])) {
    ...
    // Search in Name
    $query = "SELECT * FROM `episodes` WHERE name LIKE '%{$search_term}%' ORDER BY id DESC LIMIT 50";
    ...
    if(mysqli_num_rows($execut) > 0){
            ...
            <tr>
                ...
                <td>
                    <button class="action-btn" title="Edit" id="toggleupdate">
                        <a href="update-movie?upeid=<?php echo $fetch['id']; ?>" style="text-decoration-line: none; color: white;">
        ...
        echo "<tr><td colspan='7' style='text-align:center;'>No episodes found</td></tr>";
    }
    exit(); 
}
...
if (isset($_SESSION['email']) && isset($_SESSION['key'])) {
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])){
        ...
        $whereClause = "WHERE name LIKE '%$search_val%'";
    ...
    $sql_count = "SELECT COUNT(id) FROM episodes $whereClause";
...
<body>
        ...
        <div class="admin-main">
            ...
            <div class="admin-content">
                <div class="content-header">
                    ...
                    <div>
                        <button class="btn btn-secondary" onclick="window.location.href='episodes'">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            // Changed to ID DESC to show newest uploads first
                            $select = "SELECT * FROM `episodes` $whereClause ORDER BY id DESC LIMIT $start_from, $limit";
    ...
    <script>
        ...
        document.getElementById('liveSearchInput').addEventListener('keyup', function() {
            ...
            .then(data => {
                document.getElementById('episodesTableBody').innerHTML = data;
