...
$allowedFiles = [
    // CSS Files
    'bootstrap' => 'assets/cb25saW5lss/play-style.css',
    
    // JS Files
    '=bG9hZGpz=' => 'assets/jf245bd2d5s/play-script.js',
    '=BwFpbmpz=' => 'assets/jf245bd2d5s/popup-wait.js',
    '=hSE44tksns=' => 'assets/jf245bd2d5s/cmVhY3Q=/Main-YXBw/play-serie-app.js',
    '=38CnaWSydj=' => 'assets/jf245bd2d5s/cmVhY3Q=/Main-YXBw/play-movie-app.js'
];
