...
if (preg_match('#/movies/$#', $current_uri)) {
...
$appJSToken = generateAssetToken('=TS89nssk=', 300);
...
if ($cachedContent) {
    ...
    echo $output;
    // echo "✅ This is Loaded from cache"; // Uncomment for debug
    exit;
}
...
define('BASE_URL', '/');
define('ITEMS_PER_PAGE', 24); // Number of movies per page
...
// 1. GET FILTER OPTIONS (Translators & Years)
$translators = [];
$t_res = $connect->query("SELECT DISTINCT translator FROM movies WHERE translator IS NOT NULL AND translator != '' ORDER BY translator ASC");
...
$sql = "SELECT SQL_CALC_FOUND_ROWS * FROM movies WHERE " . implode(' AND ', $where) . " ORDER BY $order LIMIT ? OFFSET ?";
...
$total_movies = $total_res->fetch_row()[0];
...
<head>
    ...
    <title>Agasobanuye Movies | The One Movies</title>
    <meta name="description" content="Explore hundreds of Agasobanuye movies in HD. Stream the best action, horror, romance, and drama films instantly on The One Movies.">
    <meta name="author" content="The One Movies">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://theonemovies.com/movies">

    <meta property="og:type" content="website">
    <meta property="og:site_name" content="The One Movies">
    <meta property="og:title" content="Browse Agasobanuye Movies - The One Movies">
    <meta property="og:description" content="Watch the best Agasobanuye Movies. Action, Horror, Comedy, and more.">
    <meta property="og:image" content="https://theonemovies.com/logo.png">
    <meta property="og:url" content="https://theonemovies.com/movies">
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"CollectionPage","@id":"https://theonemovies.com/movies/#webpage","url":"https://theonemovies.com/movies","name":"Agasobanuye Movies","description":"Explore hundreds of Agasobanuye movies in HD.","isPartOf":{"@type":"WebSite","@id":"https://theonemovies.com/#website"}}</script>
</head>
<body>
...
function generateAssetToken($file = 'bootstrap', $expiry = 300) {
    ...
    return ['token' => $token, 'expiry' => $expiryTime, 'url' => "4F2iL7eXwK?file=$file&token=$token"];
}
